...
namespace Tikshuv.FrontEnd.StorageWindow.StorageManager
{
    partial class DeleteEquipment
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.dgvTable.AllowUserToDeleteRows = true;
            this.dgvTable.AllowUserToResizeColumns = true;
            this.dgvTable.RowHeadersVisible = true;
            this.dgvTable.ReadOnly = false;
            this.dgvTable.UserDeletingRow += DgvTable_UserDeletingRow;
            // 
            // UpperPanel
            // 
